...
public class ReservasAsincServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        for (int i = 0; i < reservas.size(); i++) {
            ...
            jsonBuilder.append("{")
                .append("\"NickC\":\"").append(p.getNickC()).append("\"").append(",")
                .append("\"NomV\":\"").append(p.getNomV()).append("\"").append(",")
                .append("\"tipoAsiento\":\"").append(p.getTipoAsiento()).append("\"").append(",")
                .append("\"FechaReserva\":\"").append(p.getFechaReservaFormatted()).append("\"").append(",")
                ...
                //.append("\"TipoReserva\":\"").append(p.getFechaReserva()).append("\"").append(",")
                .append("\"pasajeros\":\"");
