...
public class Paquete {
	...
	public Paquete(String nombre, String descripcion, int validezDias, float descuento, float costo, LocalDate fechaAlta, ArrayList<DataRutaVueloPaquete> rutasPaquete) {
		this.nombre = nombre;
	...
	public void addCompraCliente(Cliente cli) {
